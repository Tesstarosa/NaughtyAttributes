...
namespace NaughtyAttributes.Test
{
	public class DisableIfTest : MonoBehaviour
	{
		...
		[DisableIf(EConditionOperator.And, "disable1", "disable2")] [ReorderableList]
		public int[] disableIfAll;

		[DisableIf(EConditionOperator.Or, "disable1", "disable2")] [ReorderableList]
		public int[] disableIfAny;

		[DisableIf("enum1", DisableIfEnum.Case0)] [ReorderableList]
		public int[] disableIfEnum;

		[DisableIf("enum2", DisableIfEnumFlag.Flag0)] [ReorderableList]
		public int[] disableIfEnumFlag;

		[DisableIf("enum2", DisableIfEnumFlag.Flag0 | DisableIfEnumFlag.Flag1)] [ReorderableList]
