...
namespace NaughtyAttributes.Test
{
	public class HideIfTest : MonoBehaviour
	{
		...
		[HideIf(EConditionOperator.And, "hide1", "hide2")] [ReorderableList]
		public int[] hideIfAll;

		[HideIf(EConditionOperator.Or, "hide1", "hide2")] [ReorderableList]
		public int[] hideIfAny;

		[HideIf("enum1", HideIfEnum.Case0)] [ReorderableList]
		public int[] hideIfEnum;

		[HideIf("enum2", HideIfEnumFlag.Flag0)] [ReorderableList]
		public int[] hideIfEnumFlag;

		[HideIf("enum2", HideIfEnumFlag.Flag0 | HideIfEnumFlag.Flag1)] [ReorderableList]
	...
	public class HideIfNest1
	{
		...
		[HideIf("Enum1", HideIfEnum.Case1)] [AllowNesting] // Because it's nested we need to explicitly allow nesting
		public int hideIfEnum;

		[HideIf("Enum2", HideIfEnumFlag.Flag0)] [AllowNesting]
		public int hideIfEnumFlag;

		[HideIf("Enum2", HideIfEnumFlag.Flag0 | HideIfEnumFlag.Flag1)] [AllowNesting]
		public int hideIfEnumFlagMulti;
	...
	public class HideIfNest2
	{
		...
		public Vector2 hideIfAll = new(0.25f, 0.75f);

		[HideIf(EConditionOperator.Or, "GetHide1", "GetHide2")]
		[MinMaxSlider(0.0f, 1.0f)]
		// AllowNesting attribute is not needed, because the field is already marked with a custom naughty property drawer
		public Vector2 hideIfAny = new(0.25f, 0.75f);

		[HideIf("GetEnum1", HideIfEnum.Case2)]
		[MinMaxSlider(0.0f, 1.0f)]
		// AllowNesting attribute is not needed, because the field is already marked with a custom naughty property drawer
		public Vector2 hideIfEnum = new(0.25f, 0.75f);
